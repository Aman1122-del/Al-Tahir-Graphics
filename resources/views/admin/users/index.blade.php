                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('admin.users.show', $user) }}"
                                                    class=" px-2 py-1 rounded text-white hover:text-indigo-900 bg-green-600">View</a>
                                                <a href="{{ route('admin.users.edit', $user) }}"
                                                    class="px-2 py-1  rounded text-white bg-blue-600 hover:text-yellow-900">Edit</a>
                                                @if ($user->id !== auth()->id())
                                                    <form method="POST" action="{{ route('admin.users.destroy', $user) }}"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="px-2 py-1 rounded bg-red-600 text-white hover:text-red-900">Delete</button>
                                                    </form>
                                                @endif
                                            </div>
                                        </td>
