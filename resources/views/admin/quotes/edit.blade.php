        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-3xl font-bold">Edit Quote - {{ $quote->quote_number }}</h1>
                ...
                <form method="POST" action="{{ route('admin.quotes.update', $quote) }}">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="customer_name" value="{{ old('customer_name', $quote->customer_name) }}" required
                                ...
                                <div>
                                    ...
                                    <input type="email" name="customer_email" value="{{ old('customer_email', $quote->customer_email) }}" required
                                           class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="customer_phone" value="{{ old('customer_phone', $quote->customer_phone) }}"
                                           class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select name="status" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <option value="approved" {{ old('status', $quote->status) === 'approved' ? 'selected' : '' }}>Approved</option>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="estimated_price" value="{{ old('estimated_price', $quote->estimated_price) }}" step="0.01" min="0"
                                           class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <select name="assigned_designer_id" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        @foreach($designers as $designer)
                                            <option value="{{ $designer->id }}" {{ old('assigned_designer_id', $quote->assigned_designer_id) == $designer->id ? 'selected' : '' }}>
                                                {{ $designer->name }}
                                            </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg mt-6">
                        ...
                        <div>
                            <textarea name="project_description" rows="6" required
                                      class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                      placeholder="Describe the project requirements...">{{ old('project_description', $quote->project_description) }}</textarea>
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg mt-6">
                        ...
                        <div>
                            <textarea name="requirements" rows="4"
                                      class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                      placeholder="List specific requirements, specifications, or constraints...">{{ old('requirements', $quote->requirements) }}</textarea>
                            @error('requirements')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div>
                                <textarea name="designer_notes" rows="4"
                                          class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                          placeholder="Add designer notes about this quote...">{{ old('designer_notes', $quote->designer_notes) }}</textarea>
