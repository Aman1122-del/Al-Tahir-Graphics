                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-4">
                            <a href="{{ route('admin.orders.export', ['format' => 'csv']) }}"
                                ...
                                <select name="designer"
                                    ...
                                    @foreach ($designers as $designer)
                                        <option value="{{ $designer->id }}"
                                            {{ request('designer') == $designer->id ? 'selected' : '' }}>
                                            {{ $designer->name }}
                                        </option>
                                    @endforeach
                                </select>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('admin.orders.show', $order) }}"
                                                    class="text-white px-2 py-1 bg-green-600 rounded hover:text-indigo-900">View</a>
                                                <a href="{{ route('admin.orders.edit', $order) }}"
                                                    class="text-white px-2 py-1 bg-blue-600 rounded hover:text-yellow-900">Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                                @empty
