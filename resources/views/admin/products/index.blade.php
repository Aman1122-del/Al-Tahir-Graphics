            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50" data-product-id="{{ $product->id }}">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $product->samples_count ?? $product->samples->count() }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="status-badge inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $product->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            <div class="space-y-3">
                                ...
                                <a href="{{ route('admin.products.create') }}" class="btn-primary">Create Product</a>
                            </div>
                        </td>
                    </tr>
                    @endforelse
